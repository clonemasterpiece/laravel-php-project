...
@section("title") Steph Store - Statistics Admin Page @endsection
        ...
        <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <p class="navbar-brand">Statistics Table</p>
                </div>
                            ...
                            <table class="table" id="users">
                                ...
                                @foreach($users as $u)
                                    <tr>
                                        ...
                                        <td name="nameUser">{{$u->name_user}}</td>
                                        <td name="lastNameUser">{{$u->last_name}}</td>
                                        <td name="emailUser">{{$u->email_user}}</td>
